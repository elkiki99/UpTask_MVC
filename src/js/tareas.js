(function() {
    ...
    async function agregarTarea(tarea) {
        ...
        try {
            const url = "/api/tarea";
            const respuesta = await fetch(url, {
                method: "POST",                     // Por default fetch tiene el metodo como get, por eso lo especificamos en este caso
                body: datos
            });
...
})();           // IIFE (Inmediately Invoqued Function Expression), no necesitamos de un DOM, Content Loaded